...
<?= $this->section('css') ?>
<link href="<?= base_url(); ?>/css/mentions.css" rel="stylesheet">
<?= $this->endSection() ?>
...
<div class="title-mentions">
  <h1 class="h1">Mentions légales et politique de confidentialité</h1>
</div>


<div class="legale">
  <div class="text-mentions">
    <p>L'entreprise individuelle KeepKids, soucieuse des droits des individus, notamment au regard des
      ...
      actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits.</p>
  </div>
  <div class="text-mentions">
    <p>Pour toute information complémentaire sur la protection des données personnelles, nous vous invitons à
      consulter le site : <a href="https://www.cnil.fr/" target="_blank">https://www.cnil.fr/</a></br>
  ...
  <div class="text-mentions">
    ...
    L'entreprise KeepKids est hébergé par Hostinger, dont le siège social est situé 61 Lordou Vironos st. <br>
    6023 Larnaca République de Chypre.
  </div>
  ...
  <div class="text-mentions">
    ...
    <p>Vos données sont collectées par l'entreprise individuelle KeepKids. <br>
  ...
  <div class="text-mentions">
    ...
    <p>La Plateforme conserve vos données pour la durée nécessaire pour vous fournir ses services ou
    son assistance. <br>
    ...
    fermé votre compte ou que nous n'ayons plus besoin pour vous fournir nos services.</p>
  </div>
  ...
  <div class="text-mentions">
    ...
    présentées contre la Plateforme et se conformer aux procédures administratives et judiciaires.</p>
  </div>
  ...
  <div class="text-mentions">
    ...
    <p>toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous
