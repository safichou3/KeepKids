...
<?= $this->section('title') ?>
<h2 style="text-align: center;">Mentions légales et politique de confidentialité</h2
<?= $this->endSection() ?>

<?= $this->section('content') ?>

<div id="mentions">
    L'entreprise individuelle KeepKids, soucieuse des droits des individus, notamment au regard des
    traitements automatisés et dans une volonté de transparence avec ses clients, a mis en place une politique
    reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’
    actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits. <br>
    Pour toute information complémentaire sur la protection des données personnelles, nous vous invitons à
    consulter le site : https://www.cnil.fr/ <br>
    La poursuite de la navigation sur ce site vaut acceptation sans réserve des dispositions et conditions
    d'utilisation qui suivent. <br>
    La version actuellement en ligne de ces conditions d'utilisation est la seule opposable pendant toute la durée
    d'utilisation du site et jusqu'à ce qu'une nouvelle version la remplace. <br> <br>
    Article 1 - Mentions légales <br>
    1.1 Site (ci-après « le site ») : <br>
    KeepKids Garde d'enfants <br>
    1.2 Éditeur (ci-après « l'éditeur ») : <br>
    L'entreprise indivuduelle KeepKids <br>
    située : 20 rue aux ours 761000 <br>
    immatriculée au RCS de Rouen 909866246 <br>
    n° de téléphone : 0256956456 <br>
    adresse mail : contact@keepkids.fr <br>
    1.3 Hébergeur (ci-après « l'hébergeur ») : <br>
    Sophrologie Florence Helloin est hébergé par Hostinger, dont le siège social est situé 61 Lordou Vironos st. <br>
    6023 Larnaca République de Chypre. <br> <br>
    ...
    vigueur au titre de la propriété intellectuelle. <br>
    ...
    ne vaut pas acceptation desdites utilisations et renonciation aux poursuites. <br> <br>
    ...
    parties du site, à une catégorie déterminée d'internautes ; <br>
    ...
    virales par Internet. Vous êtes par ailleurs seul responsable des sites et données que vous consultez. <br>
    ...
    fait de votre connexion ou de votre utilisation du site et vous renoncez à toute action contre lui de ce fait. <br>
    ...
    et frais qui pourraient découler de cette procédure. <br> <br>
    ...
    l'éditeur. Tout lien devra être retiré sur simple demande de l'éditeur. <br>
    ...
    Article 7 - Collecte et protection des données <br>
    Vos données sont collectées par l'entreprise individuelle KeepKids. <br>
    ...
    Article 8 - Droit d’accès, de rectification et de déréférencement de vos données <br>
    ...
    ils peuvent demander la mise à jour des informations ; <br>
    ...
    10 C cote du mont-aux-malades 76250 Deville-les-rouen. <br>
    Ou par email, à l’adresse : <br>
    contact@keepkids.fr <br>
    ...
    de la CNIL, car nous sommes à votre entière disposition pour régler votre problème. <br> <br>
    Article 9 - Utilisation des données <br>
    ...
    traitements est l’exécution du contrat entre l’utilisateur et la Plateforme. Plus précisément, les utilisations
    ...
    l'utilisateur, selon ses préférences ; <br>
    - prévention et détection des fraudes, malwares (malicious softwares ou logiciels malveillants) et gestion des
    incidents de sécurité ; <br>
    - gestion des éventuels litiges avec les utilisateurs ; <br>
    - envoi d'informations commerciales et publicitaires, en fonction des préférences de l'utilisateur ; <br> <br>
    Article 10 - Politique de conservation des données <br>
    ...
    fermé votre compte ou que nous n'ayons plus besoin pour vous fournir nos services. <br> <br>
    Article 11- Partage des données personnelles avec des tiers <br>
    ...
    - quand la Plateforme recourt aux services de prestataires pour fournir l'assistance utilisateurs, la publicité et
    les services de paiement. Ces prestataires disposent d'un accès limité aux données de l'utilisateur, dans le
    cadre de l'exécution de ces prestations, et ont l'obligation contractuelle de les utiliser en conformité avec les
    dispositions de la réglementation applicable en matière protection des données à caractère personnel ; <br>
    - si la loi l'exige, la Plateforme peut effectuer la transmission de données pour donner suite aux réclamations
    présentées contre la Plateforme et se conformer aux procédures administratives et judiciaires. <br> <br>
    Article 12 - Offres commerciales <br>
    Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez
    cliquer sur le lien suivant : <br>
    Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection
    commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : <br>
    Si, lors de la consultation du site, vous accédez à des données à caractère personnel, vous devez vous
    abstenir de toute collecte, de toute utilisation non autorisée et de tout acte pouvant constituer une atteinte à la
    vie privée ou à la réputation des personnes. L'éditeur décline toute responsabilité à cet égard. <br>
    Les données sont conservées et utilisées pour une durée conforme à la législation en vigueur. <br> <br>
    Article 13 - Cookies <br>
    ...
    service que nous vous offrons. <br>
    Le cas échéant, des « cookies » émanant de l'éditeur du site et/ou des sociétés tiers pourront être déposés sur
    votre terminal, avec votre accord. Dans ce cas, lors de la première navigation sur ce site, une bannière
    explicative sur l’utilisation des « cookies » apparaîtra. Avant de poursuivre la navigation, le client et/ou le
    prospect devra accepter ou refuser l’utilisation desdits « cookies ». Le consentement donné sera valable pour
    une période de treize (13) mois. L'utilisateur a la possibilité de désactiver les cookies à tout moment. <br>
    Les cookies suivants sont présents sur ce site : <br>
    - W3c. <br>

    La durée de vie de ces cookies est de treize mois. <br>
    ...
    texte de loi ou réglementaire particulier. <br> <br>
    ...
    pouvez laisser un message à l'adresse suivante : contact@keepkids.fr. <br>
    Ces mentions légales et politique de confidentialité ont été créées sur le site Rocket Lawyer. <br>
</div>
<?= $this->endSection() ?>