...
$(".inputRue").keyup(function (event) {
	...
	$.get('https://api-adresse.data.gouv.fr/search/', {
		...
		$.each(data.features, function (i, obj) {
			...
			liste += '<li class="li-list-addresses"><a href="#" name="' + obj.properties.label + '" data-name="' + obj.properties.name + '" data-postcode="' + obj.properties.postcode + '" data-city="' + obj.properties.city + '">' + obj.properties.label + '</a></li>';
		});
